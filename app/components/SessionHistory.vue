...
.session-heading .session-clear {
  ...
  min-height: 2.75rem;
  padding: 0;
  /* The glyph's edge on the panel's content edge, in line with the switches
     above, and 0.5rem from the words; the 44px target reaches past both. */
  margin-inline: calc((1.125em - 2.75rem) / 2 + 0.5rem - var(--session-heading-gap))
    calc((1.125em - 2.75rem) / 2);
  border: 0;
